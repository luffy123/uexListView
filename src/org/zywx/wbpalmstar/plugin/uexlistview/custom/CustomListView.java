...
import org.zywx.wbpalmstar.plugin.uexlistview.RefreshBean;
import org.zywx.wbpalmstar.plugin.uexlistview.SwipeListView;

import java.util.Date;

public class CustomListView extends SwipeListView implements AbsListView.OnScrollListener {
    ...
    public CustomListView(Context context, int swipeBackView, int swipeFrontView) {
    ...
    public static void setHeaderViewData(RefreshBean headerViewData) {
        CustomListView.headerViewData = headerViewData;
    }

    public static void setFooterViewData(RefreshBean footerViewData) {
        CustomListView.footerViewData = footerViewData;
    }
    ...
    private void onLvRefresh() {
        if (onRefreshListener != null && mode == Mode.BOTH && (isHeaderRefreshable || isFooterRefreshable)) {
            ...
            Toast.makeText(getContext(), "both", Toast.LENGTH_SHORT).show();
            return;
        }
